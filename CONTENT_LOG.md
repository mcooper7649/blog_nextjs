...
| 2026-06-15 | post | New post "Building a REST API with Node.js, Express, and PostgreSQL" — pg.Pool setup, CRUD routes with parameterized queries, COALESCE PATCH pattern, async error-handling middleware, wrap helper, and production next-steps. |
