...
| 2026-06-29 | post | New post "Building a REST API with Express and TypeScript" — tsconfig setup, typed request bodies, typed route handlers, error-handler middleware, and pointers to Zod/Prisma/JWT for production hardening. |
