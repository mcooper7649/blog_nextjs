...
| 2026-08-23 | refactor(post) | Expand thin "API Overview" stub into full practical guide: fetch, error handling, POST/PUT/DELETE, React useEffect pattern, reusable useFetch hook, quick reference table. |
