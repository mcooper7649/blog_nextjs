...
| 2026-09-02 | post | New post "Next.js Server Actions: Type-Safe Mutations Without the API Route Boilerplate" — useActionState, progressive-enhancement forms, useOptimistic, revalidatePath/revalidateTag, when to still use Route Handlers. |
