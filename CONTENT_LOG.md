...
| 2026-08-29 | refactor(post) | Expand thin "Application Programming Interfaces" stub (57 lines, sourced bullets) into practical "Working with REST APIs in JavaScript" guide — fetch GET/POST/PUT/PATCH/DELETE, status code handling, auth headers, error handling utility, React useFetch hook, pagination patterns, URLSearchParams. |
