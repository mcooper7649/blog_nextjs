...
| 2026-06-28 | refactor(post) | Expand thin "API Overview" stub (57 lines, no code) into full practical REST API guide — fetch() patterns, error handling, auth headers, reusable wrapper, URLSearchParams, HTTP status code table, REST vs GraphQL. |
