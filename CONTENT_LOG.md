...
| 2026-09-13 | fix(post) | Fix broken webpack config code examples in webpack-module-bundler post — `modules:` → `module:`, missing commas after entry, `new HtmlWebpackPlugin()` spacing, `clean: true` boolean, and unclosed use-array brackets. |
