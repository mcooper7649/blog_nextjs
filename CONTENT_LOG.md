...
| 2026-09-08 | post(til) | New TIL "structuredClone() — Native Deep Cloning in JavaScript" — why JSON.parse/stringify breaks, structuredClone() usage with Date/Map/Set, React state update pattern, browser/Node support table. |
